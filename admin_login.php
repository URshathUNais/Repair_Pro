	...
	<div class="card card-authentication1 mx-auto my-5">
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <form name="form" action="admin/login.php" onsubmit="return isvalid()" method="post">
			  <div class="form-group">
			  <label for="exampleInputUsername" class="sr-only">Username</label>
			   <div class="position-relative has-icon-right">
				  <input name="user" type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username">
			  ...
			  <label for="exampleInputPassword" class="sr-only">Password</label>
			   <div class="position-relative has-icon-right">
				  <input name="pass" type="password" id="exampleInputPassword" class="form-control input-shadow" placeholder="Enter Password">
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
				  </div>
			   </div>
          ...
          <!-- <form  action="admin/signin.php">
            <div class="loader-wrapper">
	          <div class="card card-authentication1 mx-auto my-5">
		        ...
		        <div class="card-content p-2">
		 	      <div class="text-center">
              <button name="" type="submit" class="btn btn-light btn-block"><a href=""><b>SIGN IN</b></button>
          </form>
          -->
