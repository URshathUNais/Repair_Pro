...
$query = "SELECT * FROM employers_mobile_number JOIN employers ON employers_mobile_number.Employer_ID_FK = employers.Employer_ID;";
$result = mysqli_query($conn,$query);

//Delete Query
if(isset($_GET['deleteid']))
{
    $Employer_Mobile_Id = $_GET['deleteid'];

    $sql = "DELETE FROM `employers_mobile_number` WHERE Employer_Mobile_Number_ID  = $Employer_Mobile_Id";
...
if (isset($_POST["submit"]))
{
  ...
  $Mobile = $_POST["mobile"];
    ...
    $query = "INSERT INTO employers_mobile_number VALUES ('','$Employer','$Mobile')";
    ...
    <div id="modal_background" class="modal-content">
      ...
      <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
           <div class="form-group">
            ...
            <select class="form-control form-control-rounded" name="employer" id="employer">
                <option value=""></option>
                <?php
                  ...
                  while ($row=mysqli_fetch_array($query)) { 
                    ?>
                    <option value=<?php echo $row['Employer_ID'];?>><?php echo $row['Employer_Name'];?></option>
                    <?php 
                    } 
                    ?>
               </select>
    ...
    <div class="container-fluid">  
        ...
        <div class="col-lg-12">
          <div id="form_ta" class="card">
            <div class="card-body">
              <h5 class="card-title">Employer Mobile Number Details</h5>
              ...
              <button id="modal_btn" type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal">
                ...
                <tbody>
                  <tr>
                    ...
                    {
                    ?>
                    <td> <?php echo  $row['Employer_Mobile_Number_ID']; ?></td>
                    <td> <?php echo  $row['Employer_Name']; ?></td>
                    <td> <?php echo  $row['Mobile_Number']; ?></td>
                    <td><a href="mobile_update.php?updateid=<?php echo  $row['Employer_Mobile_Number_ID']; ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="mobile_table.php?deleteid=<?php echo  $row['Employer_Mobile_Number_ID']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
                    <?php
                    }
                    ?>
