...
$query = "SELECT * FROM jobs JOIN employers ON employers.Employer_ID = jobs.Employer_ID_FK JOIN employee_type ON employee_type.Employee_Type_ID = jobs.Employee_Type_ID_FK ORDER BY Job_ID";
$result = mysqli_query($conn,$query);

//Delete Query
if(isset($_GET['deleteid']))
{
    $Job_ID = $_GET['deleteid'];
...
if (isset($_POST["submit"]))
{
  ...
  $Discription = $_POST["discription"];
    ...
    $query = "INSERT INTO jobs VALUES('','$Employer_ID_FK','$Employee_Type_ID_FK','$Expected_Start_Date','$Expected_End_Date','$Discription')";
    ...
    <div id="modal_background" class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <select class="form-control form-control-rounded" name="employer_id_fk" id="employer_id_fk">
                <option value=""></option>
                <?php
                  $conn = mysqli_connect($s_name, $u_name, $p_word, $d_name);
                  $query = mysqli_query($conn , "select * from employers where Approved_Status = 'true'");
              ...
              <div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="job_update.php?updateid=<?php echo  $row['Job_ID']; ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="job_table.php?deleteid=<?php echo  $row['Job_ID']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
                    <?php
                    }
                    ?>
