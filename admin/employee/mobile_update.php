...
if(isset($_POST['submit']))
{
    ...
    mysqli_query($conn, "UPDATE employee_mobile_number set Employee_ID_FK ='".$_POST['employee_id']."', Mobile_Number='".$_POST['mobile']."' WHERE Employee_Mobile_Number_ID  = '".$_POST['id']."'");
    echo"<script>alert('Update Successfully');
    document.location.href = 'mobile_table.php'</script>";
}

$result = mysqli_query($conn,"SELECT * FROM employee_mobile_number WHERE Employee_Mobile_Number_ID='".$_GET['updateid']."'");
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
        <div id="reg" class="card">
           <div class="card-body">
           <div class="card-title">Employee Mobile Number Update Form</div>
           <hr>
          ...
          <input type="hidden" name="id" value=<?php  echo $_GET['updateid']; ?>  >
           <div class="form-group">
            ...
            <input type="text" name="employee_id" value="<?php echo $row['Employee_ID_FK']; ?>" class="form-control form-control-rounded" id="employee_id" >
           </div>
           <div class="form-group">
            <label for="nic number">Mobile Number</label>
