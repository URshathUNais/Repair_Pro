...
$query = "SELECT * FROM employee JOIN employee_type on employee.Employee_Type_ID_FK = employee_type.Employee_Type_ID WHERE employee.Approved_Status = 'false' ORDER by Employee_ID";
...
{
  $Employee_ID  = $_POST['pendingid'];

  $sql = "Update `employee` set Approved_Status = 'true'  WHERE Employee_ID = $Employee_ID";
  mysqli_query($conn, $sql);
  echo"<script>alert('Employee Permission Granted.');
  document.location.href = 'employee_table.php'</script>";
}
...
<head>
  ...
  <title>Employee Pending Page</title>
  <!-- loader-->
        ...
        <div class="col-lg-12">
          <div id="form_ta" class="card">
            <div class="card-body">
              ...
              <div>
                <a href="employee_table.php">
                  <button id="modal_btn" type="button" class="btn btn-outline-success">Approved Employees</button>
                </a>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                        <form  action="employee_pending.php" method="post" >
                            <input name="pendingid" type="hidden" value=<?php echo $row['Employee_ID'];  ?> />
