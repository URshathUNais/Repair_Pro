...
if(isset($_POST['submit']))
{
    ...
    mysqli_query($conn, "UPDATE employee_account_details set Employee_ID_FK ='".$_POST['employee_id_fk']."', Bank_Name='".$_POST['bank_name']."', Branch='".$_POST['branch']."', Account_Number='".$_POST['account_number']."' WHERE Employee_Account_ID = '".$_POST['id']."'");
    echo"<script>alert('Update Successfully');
    document.location.href = 'bank_account.php'</script>";
}

$result = mysqli_query($conn,"SELECT * FROM employee_account_details WHERE Employee_Account_ID ='".$_GET['updateid']."'");
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
        <div id="reg" class="card">
           <div class="card-body">
           <div class="card-title">Bank Account Details Update Form</div>
           <hr>
          <form class="" action="bank_account_update.php" method="post" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="bank_name" value="<?php echo $row['Bank_Name']; ?>" class="form-control form-control-rounded" id="bank_name">
           </div>
           <div class="form-group">
            <label for="branch">Branch</label>
            <input type="text" name="branch" value="<?php echo $row['Branch']; ?>" class="form-control form-control-rounded" id="branch">
           </div>
           <div class="form-group">
            <label for="account_number">Account Number</label>
            <input type="text" name="account_number" value="<?php echo $row['Account_Number']; ?>" class="form-control form-control-rounded" id="account_number">
           </div>
           <br>
           <div class="form-group">
