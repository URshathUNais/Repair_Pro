...
$query = "SELECT * FROM employee_mobile_number JOIN employee on employee.Employee_ID = employee_mobile_number.Employee_ID_FK;";
$result = mysqli_query($conn,$query);

//Delete Query
if(isset($_GET['deleteid']))
{
    $Employee_Mobile_Id = $_GET['deleteid'];

    $sql = "DELETE FROM `employee_mobile_number` WHERE Employee_Mobile_Number_ID  =$Employee_Mobile_Id";
...
if (isset($_POST["submit"]))
{
  ...
  $Mobile = $_POST["mobile"];
    ...
    $query = "INSERT INTO employee_mobile_number VALUES ('','$Employee','$Mobile')";
    ...
    <div id="modal_background" class="modal-content">
      ...
      <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
           <div class="form-group">
            ...
            <select class="form-control form-control-rounded" name="employee" id="employee">
                <option value=""></option>
                <?php
    ...
    <div class="container-fluid">  
        ...
        <div class="col-lg-12">
          <div id="form_ta" class="card">
            <div class="card-body">
              <h5 class="card-title">Employee Mobile Number Details</h5>
              ...
              <button id="modal_btn" type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal">
                ...
                <tbody>
                  <tr>
                    ...
                    {
                    ?>
                    <td> <?php echo  $row['Employee_Mobile_Number_ID']; ?></td>
                    <td> <?php echo  $row['Employee_Name']; ?></td>
                    <td> <?php echo  $row['Mobile_Number']; ?></td>
                    <td><a href="mobile_update.php?updateid=<?php echo  $row['Employee_Mobile_Number_ID']; ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="mobile_table.php?deleteid=<?php echo  $row['Employee_Mobile_Number_ID']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
                    <?php
                    }
                    ?>
