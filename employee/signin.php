...
if (isset($_POST["submit"]))
{
  ...
  else
  {
    ...
    else
    {
      ...
      document.location.href = '../employee_login.php'</script>";
    }
  }
}
?>
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
        <div id="reg" class="card">
           <div class="card-body">
           <div class="card-title">Employee Registration Form</div>
           <hr>
           ...
           <div class="form-group">
            ...
            <input type="date" name="dob" required value="" class="form-control form-control-rounded" id="dob" placeholder="Select the Date">
           </div>
           <div class="form-group">
